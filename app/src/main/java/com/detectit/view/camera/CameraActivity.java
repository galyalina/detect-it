...
public abstract class CameraActivity extends AppCompatActivity
    ...
    private void requestPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            requestPermissions(new String[]{PERMISSION_CAMERA, PERMISSION_ACCESS_NETWORK_STATE, PERMISSION_COARSE_LOCATION, PERMISSION_FINE_LOCATION, PERMISSION_INTERNET}, PERMISSIONS_REQUEST);
        }
    }
